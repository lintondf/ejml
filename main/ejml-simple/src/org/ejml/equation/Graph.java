...
public class Graph<T> {
	 ...
	 * Get the root vertex
	 * 
	 * @return the root vertex if one is set, null if no vertex has been set as the
	 *         root.
	 */
	...
	/**
	 * Clear the mark state of all verticies in the graph by calling clearMark() on
	 * all verticies.
	 * 
	...
	/**
	 * Clear the mark state of all edges in the graph by calling clearMark() on all
	 * edges.
	 */
	...
	/**
	 * Perform a depth first serach using recursion. The search may be cut short if
	 * the visitor throws an exception.
	 * 
	 * @param         <E>
	 * 
	 * @param v       - the Vertex to start the search from
	...
	/**
	 * Perform a breadth first search of this graph, starting at v. The vist may be
	 * cut short if visitor throws an exception during a vist callback.
	 * 
	 * @param         <E>
	 * 
	 * @param v       - the search starting point
	 ...
	 * 
	 * @param v       - the vertex to start the search from
	 * @param visitor - visitor invoked after each vertex is visited and an edge is
	 *                added to the tree.
	 */
...
class Vertex<T> {
	...
	/**
	 * Add an edge to the vertex. If edge.from is this vertex, its an outgoing edge.
	 * If edge.to is this vertex, its an incoming edge. If neither from or to is
	 * this vertex, the edge is not added.
	 * 
	 ...
	 * @return true if the edge was removed, false if the edge was not connected to
	 *         this vertex
	 */
